...
│          └─ ... │ - номер рядка
│                 ├─ c\...\ - заміна поточного рядка на новий
│                 ├─ d - видалити рядок
│                 └─ a - додати рядок після цього рядка
...
│  └─ sudo - виконання всього скрипта від root
├─ chmod +x .../... - добавляє права на виконання скрипта користувачем
├─[ параметри ]
